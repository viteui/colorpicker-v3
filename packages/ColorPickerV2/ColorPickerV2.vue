<template>
    <div class="wcrane-colorpicker" v-clickoutside="closePanel">
        <div class="wcrane-color-picker-btn" :style="{ ...btnStyle }" @click="openPanel">
            <div class="wcrane-color-picker-btn-color" :style="{ background: colorObj.rgba }"></div>
        </div>
        <div class="color-select" :class="[colorPanelVisible ? 'colorpicker__visible' : '']">
...
export default defineComponent({
    ...
    setup(props: { color: string }, context) {
...
.wcrane-color-picker-btn .wcrane-color-picker-btn-color {
